...
const Detail = (props) => {
    ...
    return Object.keys(beerData).length ? (
        <>
            <div className="detail-box">
                <div className="part-one">
                    <a
                        href={beerData.image_url}
                        target="_blank"
                        className="my-4"
                    >
                ...
                <div className="part-two">
                    ...
                    <div className="detail-item">
                        <span className="q">description :</span>{" "}
                        {beerData.description}
                    </div>
                    <div className="detail-item">
                        <span className="q">first brewed :</span>{" "}
                    ...
                    <div className="detail-item">
                        <span className="q">ingredients :</span> malt (
                        {ingre.malt}), hops ({ingre.hops}), yeasts (
                        {ingre.yeasts})
                    </div>
                    <div className="detail-item">
                        <span className="q">brewers tips: </span>{" "}
                        {beerData.brewers_tips}
                    </div>
                    <div className="detail-item">
                        <span className="q">contributed_by :</span>{" "}
